...
export default function Scene({}: Props) {
  ...
  useGSAP(() => {
    ...
    scrollTl
      ...
      .to(can1Ref.current.position, { x: -0.2, y: -0.7, z: -0.2 }, 0)
  ...
  return (
    <group ref={groupRef}>
      <group ref={can1GroupRef}>
        <FloatingCan ref={can1Ref} flavor="festival" floatSpeed={FLOAT_SPEED} />
      </group>
      <group ref={can2GroupRef}>
        <FloatingCan ref={can2Ref} flavor="tribune" floatSpeed={FLOAT_SPEED} />
      </group>
      <group>
        <FloatingCan
          ref={can3Ref}
      ...
      <group>
        <FloatingCan ref={can4Ref} flavor="lonerism" floatSpeed={FLOAT_SPEED} />
      </group>
      <group>
        <FloatingCan ref={can5Ref} flavor="slowRush" floatSpeed={FLOAT_SPEED} />
      </group>
